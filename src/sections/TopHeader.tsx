          ...
          <div className="flex items-center justify-between h-[72px]">
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="p-6 border-t space-y-3">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-between w-full px-4 py-3 rounded-full bg-white text-black text-[12px] font-sans font-semibold tracking-[0.08em] border border-gray-200 hover:bg-gray-50 transition-colors"
                      >
                        View Dental Clinic
                        <ArrowUpRight className="w-4 h-4 flex-shrink-0" />
                      </a>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden sm:flex items-center gap-1.5 px-3 sm:px-4 py-2 rounded-full bg-white text-black text-[12px] font-sans font-semibold tracking-[0.08em] uppercase hover:bg-gray-100 transition-colors whitespace-nowrap"
              >
