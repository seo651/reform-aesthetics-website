      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-2xl">
          ...
          >
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-black text-sm font-medium hover:bg-gray-100 transition-all hover:scale-[1.02]"
            >
            ...
            <a
              href="#services"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-black/40 text-white text-sm font-medium border border-white/30 hover:bg-black/50 transition-all hover:scale-[1.02]"
            >
