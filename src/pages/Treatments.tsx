        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection>
            <div className="text-center mb-14">
              ...
              <h2
                className="text-3xl sm:text-4xl lg:text-[48px] leading-[1.15] mt-6 text-gray-900"
                style={{ fontFamily: '"Times New Roman", Times, serif', fontWeight: 400 }}
              >
                Explore Our Full Range
              </h2>
              <p className="text-gray-500 text-[15px] leading-relaxed mt-4 max-w-xl mx-auto font-sans">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {treatmentGroups.map((group, groupIdx) => (
              ...
              >
                <h3
                  className="text-xl text-gray-900 mb-5 pb-4 border-b border-gray-100"
                  style={{ fontFamily: '"Times New Roman", Times, serif', fontWeight: 400 }}
                >
                  {group.category}
                </h3>
                <ul className="space-y-1">
                  {group.treatments.map((t) => (
                    <li key={t.href + t.label}>
                      <Link
                        to={t.href}
                        className="flex items-center justify-between py-2.5 text-gray-600 hover:text-gray-900 text-[14px] font-sans group transition-colors border-b border-gray-50 last:border-b-0"
                      >
                        <span>{t.label}</span>
                        <ArrowUpRight className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-opacity text-[#c4a882]" />
                      </Link>
                    </li>
                  ))}
                </ul>
