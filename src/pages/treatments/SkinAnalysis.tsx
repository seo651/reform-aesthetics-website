...
export default function SkinAnalysis() {
  return (
    <TreatmentPage
      ...
      heroImage="/images/skin-analysis-banner.png"
      ...
      circularImage="/images/skin-analysis-scanner.jpg"
      circularImageAlt="OBSERV 520x 3D skin analysis device"
      ...
      benefitsImage="/images/skin-analysis-treatment.jpg"
