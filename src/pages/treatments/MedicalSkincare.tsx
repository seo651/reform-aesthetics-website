...
export default function MedicalSkincare() {
  return (
    <TreatmentPage
      ...
      heroImage="/images/medical-skincare-new-hero.png"
      ...
      circularImage="/images/medical-skincare-new-circular.png"
      ...
      benefitsImage="/images/medical-skincare-new-benefits.png"
